# review-with-codex — finding presentation format

For every finding you surface — whether it's Codex's own output or an upstream PR comment you're summarising (Copilot, a past reviewer, etc.) — lead with a verbatim three-line block:
